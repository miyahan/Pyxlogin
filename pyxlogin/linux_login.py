...
class LinuxLogin(Pyxlogin):
    ...
    PROMPT_USERNAME = r'[Ll]ogin:\s*$'
    PROMPT_PASSWORD = r'([pP]assword|パスワード):\s*$'
    PROMPT_ENABLE = r'[-_@~()[\]\s\w]+\#\s*$'
    PROMPT_LOWAUTH = r'[-_@~()[\]\s\w]+\$\s*$'
    ENABLE_COMMAND = 'su'
    INNIT_COMMANDS = []
    EXIT_COMMAND = 'exit'
    LINESEP = '\n'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Telnet/SSH Linux/UNIX servers and execute commands',
        prog='linux_login.py',
